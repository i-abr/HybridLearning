...
class PolicyNetwork(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_size, init_w=3e-3, log_std_min=-4, log_std_max=2):
        ...
        self.var_linear1 = nn.Linear(num_inputs, hidden_size)
        self.var_linear2 = nn.Linear(hidden_size, hidden_size)
    ...
    def forward(self, state):
        ...
        log_std = F.relu(self.var_linear2(F.relu(self.var_linear1(state))))
